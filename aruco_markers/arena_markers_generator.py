...
Description
-----------
Generates a PDF file with square ArUco markers of specified IDs, centered on A4 pages,
with the marker ID indicated in the top margin.
...
with PdfPages("arena_markers.pdf") as pdf:
    for marker_id in marker_ids:
        ...
        marker_img = cv2.aruco.generateImageMarker(
            dictionary, marker_id, marker_img_size
        )
        ...
        ax.imshow(
            marker_img, cmap="gray", interpolation="nearest", extent=[x0, x1, y0, y1]
        )
